...
public class LeaveAllocationsService(ApplicationDbContext _context, IMapper _mapper, 
    IUserInfoService userInfoService, UserManager<ApplicationUser> _userManager) : ILeaveAllocationsService 
{
